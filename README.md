...
│   ├── /test                          # テスト層
│   │   ├── /unit                      # ユニットテスト
│   │   │   ├── user_usecase_test.go   # ユーザーのユニットテスト
│   │   │   ├── portfolio_usecase_test.go # ポートフォリオのユニットテスト
│   │   │   └── asset_usecase_test.go  # 資産のユニットテスト
│   │   ├── /integration               # 統合テスト
│   │   │   └── portfolio_integration_test.go # ポートフォリオ統合テスト
│   │   └── /mock                      # モックデータとモックインターフェース
│   │       └── portfolio_mock.go      # ポートフォリオのモック
│
